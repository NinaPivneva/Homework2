...
// // // Функция принимает число от пользователя, количество символов, и выводит третью цифру числа. Если 3 цифры нет, сообщает и выводит 0.
// int MakeArray(int a, int b)
// {
// int result = 0;
//     if (b < 3)
//     {
//         Console.Write("Третьей цифры нет, там просто ");
//     }
//     else
//     {
//         int c = 1;
